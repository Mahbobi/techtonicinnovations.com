...
/** Rendered as a bold, boxed callout directly below the intro on /terms. */
export const termsArbitrationNotice = `Important: the "Dispute resolution" section below contains a binding arbitration agreement and class-action and jury-trial waivers that affect your legal rights — please read it carefully. You can opt out of arbitration within 30 days, as described in that section.`;
...
export const termsSections: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      `Informal resolution first. Before starting arbitration or a court case, you agree to email ${SITE.email} with a description of the dispute and the relief you want, and to try in good faith to resolve it with us for at least 60 days.`,
      "Binding individual arbitration. Except as stated below, any dispute, claim, or controversy arising out of or relating to these Terms or the Site (including their formation, scope, or enforceability) will be resolved by final and binding arbitration administered by the American Arbitration Association (AAA) under its Consumer Arbitration Rules or, if you use the Site on behalf of a business, its Commercial Arbitration Rules, before a single arbitrator. Unless you and we agree otherwise, the arbitration will take place in the county where you live or by video conference or written submissions (for business users, Fairfax County, Virginia). The arbitrator may award the same individual relief a court could, and judgment on the award may be entered in any court with jurisdiction. Fees are allocated according to the AAA rules that apply.",
      "Class-action and jury-trial waiver. You and we each agree to bring claims only in an individual capacity, and not as a plaintiff or class member in any purported class, collective, consolidated, or representative proceeding. The arbitrator may not consolidate claims of more than one person or preside over any form of class or representative proceeding. TO THE MAXIMUM EXTENT PERMITTED BY LAW, YOU AND WE EACH WAIVE THE RIGHT TO A JURY TRIAL. If this class-action waiver is found unenforceable as to a particular claim, that claim (and only that claim) must be severed and brought in court, and the rest of this section still applies.",
      "Mass arbitration. If 25 or more similar demands for arbitration are filed against us by the same or coordinated counsel, they will be administered in batches of up to 50 under the AAA's mass-arbitration procedures; demands not in the current batch are held in abeyance, and limitations periods are tolled while held.",
